...
export default function Home() {
  return <>
    ...
    <header className="header">
      <div className="header-brand"><Image className="alaya-lab-logo" src="/assets/alaya-lab-logo.png" alt="Alaya Lab" width={313} height={265} unoptimized /><span className="header-brand-divider" aria-hidden="true" /><a href="#home" className="wordmark" aria-label="AlayaVista home">Alaya<span>Vista</span><span className="brand-dot" /></a></div>
