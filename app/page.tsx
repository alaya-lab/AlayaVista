...
export default function Home() {
  return <>
    ...
    <header className="header">
      ...
      <a className="header-paper" href="https://arxiv.org/abs/2609.14462" target="_blank" rel="noreferrer">Read the paper <ArrowUpRight size={15} /></a>
    </header>
    <main>
      <section id="home" className="hero">
        ...
        <div className="hero-content">
          ...
          <div className="hero-actions"><a className="action action-light" href="https://arxiv.org/abs/2609.14462" target="_blank" rel="noreferrer"><FileText size={17} /> Read the paper <ArrowUpRight size={16} /></a><a className="action action-glass" href="https://github.com/AlayaLab/AlayaVista" target="_blank" rel="noreferrer"><Code2 size={17} /> Code <ArrowUpRight size={16} /></a><a className="action action-glass" href="#intro-video"><Play size={17} /> Watch video</a></div>
        </div>
      ...
      <section id="citation" className="section citation-section content-width"><Label n="06">CITATION</Label><div className="section-heading"><h2>Build on <em>AlayaVista.</em></h2><a className="text-link" href="https://arxiv.org/abs/2609.14462" target="_blank" rel="noreferrer">Read the full paper <ArrowUpRight size={17} /></a></div><Citation /></section>
    </main>
